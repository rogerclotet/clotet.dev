import Revealing from "@/app/_components/revealing";
...
export default function WorkExperience() {
  return (
    <div>
      <div className="flex flex-wrap gap-4 justify-between items-baseline py-4 border-[rgb(var(--primary))] border-b-2 mr-4">
      ...
      {workExperience.map((job, idx) => (
        <Revealing key={idx}>
          <div
            key={idx}
            className={cn(
              "px-4 py-2 lg:px-8 lg:py-4 border-[rgb(var(--primary))] border-t-2 mt-[-2px] border-b-2",
              {
